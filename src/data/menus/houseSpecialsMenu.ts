...
export const houseSpecialsMenu: MenuItem[] = [
  ...
  },
  {
    ...
    category: 'House Specials',
    temperature: 'both',
    includedToppings: ['Roast beef', 'Smoked turkey', 'Swiss cheese', 'Lettuce', 'Tomato', 'Onions', 'Sweet peppers', 'Thousand island dressing'],
    customization: {
      breads: baseBreads,
      veggies: commonVeggies,
      cheeses: commonCheeses,
  ...
  },
  {
    id: 405,
    name: 'Italian Combo',
    description: 'Genoa salami, cappy style ham and deluxe ham with veggies and dressings',
    price: {
      regular: 6.99,
      sub: 8.99
    },
